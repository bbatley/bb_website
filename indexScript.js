...
link.style.display = 'none';
link = document.querySelector('a[tp="5335%20Brookview"]');
link.style.display = 'none';
...
link.style.display = 'none';
link = document.querySelector('a[tp="1749%20Marissa"]');
link.style.display = 'none';
...
link.style.display = 'none';
link = document.querySelector('a[tp="2707D%204th"]');
link.style.display = 'none';
...
link.style.display = 'none';
link = document.querySelector('a[tp="2021%20Autumn"]');
link.style.display = 'none';
link = document.querySelector('a[tp="2023%20Autumn"]');
link.style.display = 'none';
